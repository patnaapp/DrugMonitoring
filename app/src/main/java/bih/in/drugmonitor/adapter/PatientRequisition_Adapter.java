...
public class PatientRequisition_Adapter extends BaseAdapter
{
    Activity activity;
    ...
    public PatientRequisition_Adapter(Activity listViewshowedit, ArrayList<SurfaceSchemeEntity> rlist, UserDetails userInfo) {
